...
for eco in prod1:
    ...
    swrad1 = swrad[swrad['p_value']>4.806]
    ...
    shortGrass1 = shortGrass[shortGrass['p_value']>4.806]
    ...
    tallGrass1 = tallGrass[tallGrass['p_value']>4.806]
    ...
    fig.suptitle('county'+str(eco))
    ax1.plot(tavg['Week_Number'],tavg['p_value'])
    ax1.axhline(y=4.806, c="gray", linewidth=1, zorder=0)
    tavgWeeks = []
    for i in tweek:
    ...
    ax2.axhline(y=4.806, c="gray", linewidth=1, zorder=0)
    dgddWeeks = []
    for i in gweek:
    ...
    ax3.axhline(y=4.806, c="gray", linewidth=1, zorder=0)
    pptWeeks = []
    for i in pweek:
        pptWeeks.append(i[0])
    ...
    ax4.axhline(y=4.806, c="gray", linewidth=1, zorder=0)
    sradWeeks = []
    for i in sweek:
    ...
    ax5.axhline(y=4.806, c="gray", linewidth=1, zorder=0)
    sgrassWeeks = []
    for i in sgweek:
    ...
    ax6.axhline(y=4.806, c="gray", linewidth=1, zorder=0)
    tgrassWeeks = []
    for i in tgweek:
    ...
    plt.savefig('./Results/county'+str(eco))
    #plt.show()
